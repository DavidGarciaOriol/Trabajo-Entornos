...
public class AllTests {
    ...
    //PRUEBAS METODO 6
    @Test
    @DisplayName("Prueba 1: sonIguales")
    void sonIguales1() {//Ambas pelis son iguales.
        Director Tarantino = new Director("Tarantino");
    ...
    @Test
    @DisplayName("Prueba 2: sonIguales")
    void sonIguales2() {//Tienen diferente titulo por lo tanto no son iguales.
        Director Tarantino = new Director("Tarantino");
        Fecha fecha1 = new Fecha(20, 4, 2004);
        Pelicula p1 = new Pelicula("Pulp Fiction", Tarantino, Genero.ACCION, fecha1);
    ...
    @Test
    @DisplayName("Prueba 3: sonIguales")
    void sonIguales3() {//Tienen diferente director por lo tanto no son iguales.
        Director Tarantino = new Director("Tarantino");
        Director Spielberg = new Director("Spielberg");
        Fecha fecha1 = new Fecha(20, 4, 2004);
        Pelicula p1 = new Pelicula("Pulp Fiction", Tarantino, Genero.ACCION, fecha1);
    ...
    @Test
    @DisplayName("Prueba 4: sonIguales")
    void sonIguales4() {//Tienen diferente genero por lo tanto no son iguales.
        Director Tarantino = new Director("Tarantino");
        Fecha fecha1 = new Fecha(20, 4, 2004);
        Pelicula p1 = new Pelicula("Pulp Fiction", Tarantino, Genero.ACCION, fecha1);
    ...
    @Test
    @DisplayName("Prueba 5: sonIguales")
    void sonIguales5() {//Tienen diferente fecha por lo tanto no son iguales.
        Director Tarantino = new Director("Tarantino");
        Fecha fecha1 = new Fecha(20, 4, 2004);
    ...
    @Test
    @DisplayName("Prueba 6: sonIguales")
    void sonIguales6() {//Son totalmente distintas por lo tanto no son iguales.
        Director Tarantino = new Director("Tarantino");
        Director Spielberg = new Director("Spielberg");
        Fecha fecha1 = new Fecha(20, 4, 2004);
        Fecha fecha2 = new Fecha(7, 7, 2017);
    ...
    //PRUEBAS METODO 8
    @Test
    @DisplayName("Prueba 1: hayVariedad")
//ArrayList con 9 elementos y con 9 generos.
    void hayVariedad() {
    ...
    @Test
    @DisplayName("Prueba 2: hayVariedad")
//ArrayList con 9 elementos y menos de 9 generos.
    void hayVariedad2() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
    ...
    @Test
    @DisplayName("Prueba 3: hayVariedad")
//ArrayList con 10 elementos y con 10 generos.
    void hayVariedad3() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
        Pelicula p2 = new Pelicula(Genero.ANIMACION);
        Pelicula p3 = new Pelicula(Genero.BELICO);
    ...
    @Test
    @DisplayName("Prueba 4: hayVariedad")
//ArrayList con 10 elementos y menos de 10 generos.
    void hayVariedad4() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
        Pelicula p2 = new Pelicula(Genero.ANIMACION);
    ...
    @Test
    @DisplayName("Prueba 5: hayVariedad")
//ArrayList con 11 elementos y con 11 generos.
    void hayVariedad5() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
        Pelicula p2 = new Pelicula(Genero.ANIMACION);
        Pelicula p3 = new Pelicula(Genero.BELICO);
    ...
    @Test
    @DisplayName("Prueba 6: hayVariedad")
//ArrayList con 11 elementos y con 10 generos.
    void hayVariedad6() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
        Pelicula p2 = new Pelicula(Genero.ANIMACION);
        Pelicula p3 = new Pelicula(Genero.BELICO);
    ...
    @Test
    @DisplayName("Prueba 7: hayVariedad")
//ArrayList con 11 elementos y menos de 10 generos.
    void hayVariedad7() {
        Pelicula p1 = new Pelicula(Genero.ACCION);
        Pelicula p2 = new Pelicula(Genero.ANIMACION);
        Pelicula p3 = new Pelicula(Genero.BELICO);
